...
const overviewInfo = [
    { title: "Total Normal Slot", icon: "feather-star", total_number: "50", completed_number: "22", progress: "28", chartColor: "#3454d1", color: "primary" },
    { title: "Total Booked Peak Slots", icon: "feather-file-text", total_number: "30", completed_number: "5", progress: "34", chartColor: "#25b865", color: "success" },
    { title: "Total Booked Normal SLots", icon: "feather-airplay", total_number: "20", completed_number: "20", progress: "42", chartColor: "#d13b4c", color: "danger" },
    {title: "Total Booked Peak SLot", icon: "feather-airplay", total_number: "20", completed_number: "20", progress: "42", chartColor: "#d13b4c", color: "danger"},
]
        ...
        <>
            {
                overviewInfo.map(({ completed_number, icon, id, progress, title, total_number, chartColor, color }, index) => {
                    return (
                        <div key={index} className="col-lg-3 task-overview-card">
