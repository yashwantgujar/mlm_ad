...
const AddProductForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      bikeImgs.forEach((img) => {
        data.append("bikeImg", img);
      });
  ...
  const sections = [
    { title: "Basic Info", fields: ["bikeName", "range", "warranty", "colors", "bikePrice", "quantity"] }, // ✅ quantity added
                  ...
                  <div className="row">
                    {section.fields.map((field) => (
                      <div key={field} className="col-md-6 mb-3">
                        ...
                        <input
                          type={(field === "bikePrice" || field === "quantity") ? "number" : "text"}
