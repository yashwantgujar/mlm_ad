...
// function SubdealerProductDetails() {
//   return (
//     <div></div>
//   )
// }

// export default SubdealerProductDetails



import React, { useEffect, useState } from "react";
import { useLocation, useNavigate } from "react-router-dom";
import { getAllProductsDealer, getAllProductSubDealer } from "../services/api";

const SubdealerProductDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchBike = async () => {
      try {
        const allBikes = await getAllProductSubDealer();
